...
__name(MatProgressBar_Conditional_2_Template, "MatProgressBar_Conditional_2_Template");
...
__name(MAT_PROGRESS_BAR_LOCATION_FACTORY, "MAT_PROGRESS_BAR_LOCATION_FACTORY");
var _MatProgressBar = class _MatProgressBar {
  ...
  _transitionendHandler = /* @__PURE__ */ __name((event) => {
...
__name(_MatProgressBar, "MatProgressBar");
__publicField(_MatProgressBar, "ɵfac", /* @__PURE__ */ __name(function MatProgressBar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatProgressBar)();
}, "MatProgressBar_Factory"));
__publicField(_MatProgressBar, "ɵcmp", ɵɵdefineComponent({
  type: _MatProgressBar,
  selectors: [["mat-progress-bar"]],
  hostAttrs: ["role", "progressbar", "aria-valuemin", "0", "aria-valuemax", "100", "tabindex", "-1", 1, "mat-mdc-progress-bar", "mdc-linear-progress"],
  hostVars: 10,
  hostBindings: /* @__PURE__ */ __name(function MatProgressBar_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function MatProgressBar_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_MatProgressBarModule, "MatProgressBarModule");
__publicField(_MatProgressBarModule, "ɵfac", /* @__PURE__ */ __name(function MatProgressBarModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatProgressBarModule)();
}, "MatProgressBarModule_Factory"));
__publicField(_MatProgressBarModule, "ɵmod", ɵɵdefineNgModule({
  type: _MatProgressBarModule,
  imports: [MatProgressBar],
  exports: [MatProgressBar, MatCommonModule]
}));
__publicField(_MatProgressBarModule, "ɵinj", ɵɵdefineInjector({
